...
public class WinBase extends BorderPane {
    ...
    public WinBase() {
        ...
        flowPane.setMaxWidth(311.0);
        flowPane.setPrefHeight(164.0);
        flowPane.setPrefWidth(311.0);
        ...
        label0.setPrefWidth(311.0);
        label0.setText("Wooow, You Won 10 coins.");
        ...
        dropShadow0.setColor(Color.web("0xae79ad"));
